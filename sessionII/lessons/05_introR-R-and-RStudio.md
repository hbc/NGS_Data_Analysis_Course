...
3. In the `New Project` window, choose `New Directory`. Then, choose `Empty Project`. Name your new directory `Intro-to-R` and save the project directory to the Desktop (or location of your choice).
...
6. When RStudio opens, the RStudio interface should look like:

7. Go to the `File` menu and select `New File`, and select `R Script`. Your RStudio interface should now look like: 

![RStudio interface](../img/Rstudio_interface.png "Interface" {width=40px height=400px})
...
2. **Script editor**: where you can type out commands and save to file. You can also run commands from the console.
