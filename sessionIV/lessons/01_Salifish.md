...
* Make that folder your workding directory

## Converting to psuedo-counts and performing downstream analysis
...
### Setting up to run DESeq2 on psuedocount data:

The developers of DESeq2 are aware of the abovementioned issues, so they:
* have developed a package that can make this conversion ([tximport]())
