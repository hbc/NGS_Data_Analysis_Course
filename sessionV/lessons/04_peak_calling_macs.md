...
* `_peaks.narrowPeak`: [BED6+4](https://github.com/hbc/NGS_Data_Analysis_Course/blob/master/sessionV/lessons/03_peak_calling_spp.md#file-formats) format file which contains the peak locations together with peak summit, pvalue and qvalue
